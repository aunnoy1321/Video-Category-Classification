...
%             S.sessions{6,1,1} = ;
            ...
            %Our MUSE dataset
%             S.sessions{7,1,1} = 'MuseData\S001a';
%             S.sessions{7,1,2} = 'MuseData\S001b';
%             S.sessions{7,1,3} = 'MuseData\S001c';
%             S.sessions{7,2,1} = 'MuseData\S002a';
%             S.sessions{7,2,2} = 'MuseData\S002b';
%             S.sessions{7,2,3} = 'MuseData\S002c';
%             S.sessions{7,3,1} = 'MuseData\S003a';
%             S.sessions{7,3,2} = 'MuseData\S003b';
%             S.sessions{7,3,3} = 'MuseData\S003c';
%             S.sessions{7,4,1} = 'MuseData\S004a';
%             S.sessions{7,4,2} = 'MuseData\S004b';
%             S.sessions{7,4,3} = 'MuseData\S004c';
%             S.sessions{7,5,1} = 'MuseData\S005a';
%             S.sessions{7,5,2} = 'MuseData\S005b';
%             S.sessions{7,5,3} = 'MuseData\S005c';
%             S.sessions{7,6,1} = 'MuseData\S006a';
%             S.sessions{7,6,2} = 'MuseData\S006b';
%             S.sessions{7,6,3} = 'MuseData\S006c';
%             S.sessions{7,7,1} = 'MuseData\S007a';
%             S.sessions{7,7,2} = 'MuseData\S007b';
%             S.sessions{7,7,3} = 'MuseData\S007c';
%             S.sessions{7,8,1} = 'MuseData\S008a';
%             S.sessions{7,8,2} = 'MuseData\S008b';
%             S.sessions{7,8,3} = 'MuseData\S008c';
%             S.sessions{7,9,1} = 'MuseData\S009a';
%             S.sessions{7,9,2} = 'MuseData\S009b';
%             S.sessions{7,9,3} = 'MuseData\S009c';
%             S.sessions{7,10,1} = 'MuseData\S010a';
%             S.sessions{7,10,2} = 'MuseData\S010b';
%             S.sessions{7,10,3} = 'MuseData\S010c';
            
            %Our MUSE dataset: One Subject Split Into noOfSubjectsToConvertTo Subjects
            
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            %noOfSubjectsToConvertTo FOLD CROSS VALIDATION SET
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            for i = 1:noOfSubjectsToConvertTo
                ...
                S.sessions{8,i,1} = strcat(folderPath, 'S0', s, int2str(i), 'a');
                S.sessions{8,i,2} = strcat(folderPath, 'S0', s, int2str(i), 'b');
                S.sessions{8,i,3} = strcat(folderPath, 'S0', s, int2str(i), 'c');
            end
                
            %Our MUSE dataset: One Subject Split Into 10 Subjects
%             S.sessions{8,1,1} = 'MuseDataOneSubjectSplitInto10Subjects\S001a';
%             S.sessions{8,1,2} = 'MuseDataOneSubjectSplitInto10Subjects\S001b';
%             S.sessions{8,1,3} = 'MuseDataOneSubjectSplitInto10Subjects\S001c';
%             S.sessions{8,2,1} = 'MuseDataOneSubjectSplitInto10Subjects\S002a';
%             S.sessions{8,2,2} = 'MuseDataOneSubjectSplitInto10Subjects\S002b';
%             S.sessions{8,2,3} = 'MuseDataOneSubjectSplitInto10Subjects\S002c';
%             S.sessions{8,3,1} = 'MuseDataOneSubjectSplitInto10Subjects\S003a';
%             S.sessions{8,3,2} = 'MuseDataOneSubjectSplitInto10Subjects\S003b';
%             S.sessions{8,3,3} = 'MuseDataOneSubjectSplitInto10Subjects\S003c';
%             S.sessions{8,4,1} = 'MuseDataOneSubjectSplitInto10Subjects\S004a';
%             S.sessions{8,4,2} = 'MuseDataOneSubjectSplitInto10Subjects\S004b';
%             S.sessions{8,4,3} = 'MuseDataOneSubjectSplitInto10Subjects\S004c';
%             S.sessions{8,5,1} = 'MuseDataOneSubjectSplitInto10Subjects\S005a';
%             S.sessions{8,5,2} = 'MuseDataOneSubjectSplitInto10Subjects\S005b';
%             S.sessions{8,5,3} = 'MuseDataOneSubjectSplitInto10Subjects\S005c';
%             S.sessions{8,6,1} = 'MuseDataOneSubjectSplitInto10Subjects\S006a';
%             S.sessions{8,6,2} = 'MuseDataOneSubjectSplitInto10Subjects\S006b';
%             S.sessions{8,6,3} = 'MuseDataOneSubjectSplitInto10Subjects\S006c';
%             S.sessions{8,7,1} = 'MuseDataOneSubjectSplitInto10Subjects\S007a';
%             S.sessions{8,7,2} = 'MuseDataOneSubjectSplitInto10Subjects\S007b';
%             S.sessions{8,7,3} = 'MuseDataOneSubjectSplitInto10Subjects\S007c';
%             S.sessions{8,8,1} = 'MuseDataOneSubjectSplitInto10Subjects\S008a';
%             S.sessions{8,8,2} = 'MuseDataOneSubjectSplitInto10Subjects\S008b';
%             S.sessions{8,8,3} = 'MuseDataOneSubjectSplitInto10Subjects\S008c';
%             S.sessions{8,9,1} = 'MuseDataOneSubjectSplitInto10Subjects\S009a';
%             S.sessions{8,9,2} = 'MuseDataOneSubjectSplitInto10Subjects\S009b';
%             S.sessions{8,9,3} = 'MuseDataOneSubjectSplitInto10Subjects\S009c';
%             S.sessions{8,10,1} = 'MuseDataOneSubjectSplitInto10Subjects\S010a';
%             S.sessions{8,10,2} = 'MuseDataOneSubjectSplitInto10Subjects\S010b';
%             S.sessions{8,10,3} = 'MuseDataOneSubjectSplitInto10Subjects\S010c';

            %Our MUSE dataset: One Subject Split Into noOfSubjectsToConvertTo Subjects (Overlapped)
            folderPath = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\';
            ...
            for i = 1:noOfSubjectsToConvertTo
                ...
                S.sessions{9,i,1} = strcat(folderPath, 'S0', s, int2str(i), 'a');
                S.sessions{9,i,2} = strcat(folderPath, 'S0', s, int2str(i), 'b');
                S.sessions{9,i,3} = strcat(folderPath, 'S0', s, int2str(i), 'c');
            end
            
            %Our MUSE dataset: One Subject Split Into 10 Subjects (Overlapped)
%             S.sessions{9,1,1} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S001a';
%             S.sessions{9,1,2} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S001b';
%             S.sessions{9,1,3} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S001c';
%             S.sessions{9,2,1} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S002a';
%             S.sessions{9,2,2} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S002b';
%             S.sessions{9,2,3} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S002c';
%             S.sessions{9,3,1} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S003a';
%             S.sessions{9,3,2} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S003b';
%             S.sessions{9,3,3} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S003c';
%             S.sessions{9,4,1} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S004a';
%             S.sessions{9,4,2} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S004b';
%             S.sessions{9,4,3} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S004c';
%             S.sessions{9,5,1} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S005a';
%             S.sessions{9,5,2} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S005b';
%             S.sessions{9,5,3} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S005c';
%             S.sessions{9,6,1} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S006a';
%             S.sessions{9,6,2} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S006b';
%             S.sessions{9,6,3} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S006c';
%             S.sessions{9,7,1} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S007a';
%             S.sessions{9,7,2} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S007b';
%             S.sessions{9,7,3} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S007c';
%             S.sessions{9,8,1} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S008a';
%             S.sessions{9,8,2} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S008b';
%             S.sessions{9,8,3} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S008c';
%             S.sessions{9,9,1} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S009a';
%             S.sessions{9,9,2} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S009b';
%             S.sessions{9,9,3} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S009c';
%             S.sessions{9,10,1} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S010a';
%             S.sessions{9,10,2} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S010b';
%             S.sessions{9,10,3} = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\S010c';

            %Our MUSE dataset: One Subject of 1 MIN Split Into noOfSubjectsToConvertTo Subjects
            ...
            for i = 1:noOfSubjectsToConvertTo
                ...
                S.sessions{10,i,1} = strcat(folderPath, 'S0', s, int2str(i), 'a');
                S.sessions{10,i,2} = strcat(folderPath, 'S0', s, int2str(i), 'b');
                S.sessions{10,i,3} = strcat(folderPath, 'S0', s, int2str(i), 'c');
            end
            
            
             %Our MUSE dataset: One Subject of 1 MIN Split Into
             %noOfSubjectsToConvertTo Subjects Overlapped
            ...
            for i = 1:noOfSubjectsToConvertTo
                ...
                S.sessions{11,i,1} = strcat(folderPath, 'S0', s, int2str(i), 'a');
                S.sessions{11,i,2} = strcat(folderPath, 'S0', s, int2str(i), 'b');
                S.sessions{11,i,3} = strcat(folderPath, 'S0', s, int2str(i), 'c');
            end
            
            %Our MUSE dataset: One Subject Split Into
            %noOfSubjectsToConvertTo Subjects (Overlapped) 1 MIN 10
            %Subjects
            folderPath = 'MuseDataOneSubjectSplitInto10SubjectsOverlapped\';
            ...
            for i = 1:noOfSubjectsToConvertTo
                ...
                S.sessions{12,i,1} = strcat(folderPath, 'S0', s, int2str(i), 'a');
                S.sessions{12,i,2} = strcat(folderPath, 'S0', s, int2str(i), 'b');
                S.sessions{12,i,3} = strcat(folderPath, 'S0', s, int2str(i), 'c');
            end
        ...
        function S = loadAll(S,experiment,numSplits,device)
            %loads everything
            [~,l,~] = size(S.sessions);
%             h = waitbar(0,'Loading...');
            for i=1:l
%                 waitbar(i/l,h,'Loading...');
                S.loadSubject(experiment,i,numSplits,device);
            end
%             close(h);
        end
        
        function S = loadSubject(S,experiment,subject,numSplits,device)
            ...
            for i=1:y
                if ~isempty(S.sessions{experiment,subject,i})
                    S.loadSubjectSession(experiment,subject,i,numSplits,device);
                end
            end
        end
        function S = loadSubjectSession(S,experiment,subject,session,numSplits,device)
            ...
            switch(experiment)
                ...
                case 7
                    ...
                    signal = eval('eeg');
                    numTrials = length(S.trials) + 1;
                    curTrials = S.splitCustom(signal,subject,session);
                    for i=1:length(curTrials)
                        S.trials{numTrials} = curTrials{i};
                        numTrials = numTrials + 1;
                    end                    
                case 8
                    ...
                    signal = eval('eeg');
                    numTrials = length(S.trials) + 1;
                    curTrials = S.splitCustomTwo(signal,subject,session);
                    for i=1:length(curTrials)
                        S.trials{numTrials} = curTrials{i};
                        numTrials = numTrials + 1;
                    end
                ...
                case 10
                    %Our MUSE dataset: One Subject 1 MIN Split Into 10 Subjects
                    load(S.sessions{experiment,subject,session});
                    signal = eval('eeg');
                    numTrials = length(S.trials) + 1;
                    curTrials = S.splitCustomThree(signal,subject,session,numSplits,device);
                    for i=1:length(curTrials)
                        S.trials{numTrials} = curTrials{i};
                        numTrials = numTrials + 1;
                    end
                case 11
                    %Our MUSE dataset: One Subject 1 MIN Split Into 10
                    %Subjects overlapping
                    load(S.sessions{experiment,subject,session});
                    signal = eval('eeg');
                    numTrials = length(S.trials) + 1;
                    curTrials = S.splitCustomFour(signal,subject,session,numSplits);
                    for i=1:length(curTrials)
                        S.trials{numTrials} = curTrials{i};
                        numTrials = numTrials + 1;
                    end
                case 12
                    ...
                    signal = eval('eeg');
                    numTrials = length(S.trials) + 1;
                    curTrials = S.splitCustomFive(signal,subject,session,numSplits);
                    for i=1:length(curTrials)
                        S.trials{numTrials} = curTrials{i};
                        numTrials = numTrials + 1;
                    end
    ...
    methods (Access = private)
            ...
            for i=2:numDins
                ...
                if(current - previous) > S.THRESHOLD_SPLIT_MILLIS;
                    ...
                    if(sampleB - sampleA>382)
                        ...
                        %ranges = [ranges ; [sampleA (sampleA+651)]];
        ...
        % OUR CODE
        function trials = splitCustom(S, signal, subjectid, session)
            SAMPLING_RATE = 128;
            
            numSplits = 23;
            
            %length(signal) / numSplits
            ...
            trials = {};
            for i=1:numSplits
                trials{i} = eegtoolkit.util.Trial(signal(:,first:last), session, SAMPLING_RATE, subjectid, session, eegtoolkit.util.Trial.SSVEP);
                S.subjectids = [S.subjectids subjectid];
                S.sessionids = [S.sessionids session];
        ...
        % OUR CODE
        function trials = splitCustomTwo(S, signal, subjectid, session)
            SAMPLING_RATE = 128;
            
            trials = {};
            
%             trials{1} = eegtoolkit.util.Trial(signal(1,3,:), session, SAMPLING_RATE, subjectid, session, eegtoolkit.util.Trial.SSVEP);
            trials{1} = eegtoolkit.util.Trial(signal, session, SAMPLING_RATE, subjectid, session, eegtoolkit.util.Trial.SSVEP);
            S.subjectids = [S.subjectids subjectid];
            S.sessionids = [S.sessionids session];            
        end
        
        % OUR CODE
        function trials = splitCustomThree(S, signal, subjectid, session, numSplits, device)
            
            if (device == 1)
                SAMPLING_RATE = 220;
                % 1044 is the smallest datasize among all the subjects
                windowSz = floor(1044 / numSplits);
            elseif (device == 2)
                SAMPLING_RATE = 128;
                % 410 is the smallest datasize among all the subjects
                windowSz = floor(410 / numSplits);
            end
            
            first = 1;
            last = windowSz;
            
            trials = cell(1, numSplits);            

            for i = 1:numSplits
              trials{1} = eegtoolkit.util.Trial(signal(:,first:last), session, SAMPLING_RATE, subjectid, session, eegtoolkit.util.Trial.SSVEP);                
%                 trials{i} = eegtoolkit.util.Trial(signal([4 3 1 2],first:last), session, SAMPLING_RATE, subjectid, session, eegtoolkit.util.Trial.SSVEP);
                S.subjectids = [S.subjectids subjectid];
                S.sessionids = [S.sessionids session];
        ...
        % OUR CODE
        function trials = splitCustomFour(S, signal, subjectid, session, numSplits)
            SAMPLING_RATE = 220;
            
            Percent = 10;
            
            % 1044 -> Minimum length of 1 minute EEG data from 10 subjects
%             windowSz = floor(1044 / numSplits);
            
            %Calculate the Window Size for overlapping
            windowSz = windowSizeCalculate(1044, Percent, numSplits);
            
            %calculate Percentage
            percentage = floor(windowSz * Percent / 100);             
...
%             trials{1} = eegtoolkit.util.Trial(signal(1,3,:), session, SAMPLING_RATE, subjectid, session, eegtoolkit.util.Trial.SSVEP);
          ...
          % OUR CODE
        function trials = splitCustomFive(S, signal, subjectid, session, numSplits)
            SAMPLING_RATE = 128;
               
            %Calculate the Window Size for overlapping
            % 10443 minimum number of data in EEG from all subjects
            windowSz = windowSizeCalculate(4500, 10, 10);
    
            %calculate Percentage
            percentage = floor(windowSz * 10 /100);
